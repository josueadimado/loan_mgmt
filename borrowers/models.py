...
class Borrower(models.Model):
    ...
    phone_number = models.CharField(max_length=20, null=True, blank=True)  # Changed to CharField
    ...
    guarantor_phone = models.CharField(max_length=20, null=True, blank=True)  # Changed to CharField
